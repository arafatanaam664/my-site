...
const localFile = "/home/ubuntu/webdev-static-assets/date-offset-leap-year-guide-hero.png";
const altText = "تقويم ورقي مفتوح عند الانتقال بين فبراير ومارس مع علامة مرجعية بسيطة";
...
const storageKey = `originals/${new Date().toISOString().slice(0, 10)}/date-offset-leap-year-guide-${checksum.slice(0, 12)}.png`;
