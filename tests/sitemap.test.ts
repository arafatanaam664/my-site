...
describe("sitemap المحتوى المنشور", () => {
  it("تسجل الرئيسية والقسم والروابط المنشورة فقط مع ترميز XML آمن", () => {
    const xml = renderSitemap([{ id: "1", kind: "article", slug: "a&b", title: "عنوان", excerpt: null, seo_description: null, primary_media_id: null, published_at: "2026-08-25T00:00:00Z", updated_at: "2026-08-26T00:00:00Z", media: [] }]);
