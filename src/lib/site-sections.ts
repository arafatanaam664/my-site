...
export function defaultSiteSections(): SiteSectionRecord[] {
  return [
    { id: defaultSectionIds.calendar, slug: "calendar", title: "التقويم والمواعيد", description: "تاريخ اليوم الهجري وفق أم القرى، وتحويل التاريخ الهجري والميلادي، وحساب العمر وفرق الأيام.", parentId: null, contentKind: null, navOrder: 10, enabled: true, publicVisible: true, systemKey: "calendar", destinationPath: "/calendar" },
    { id: defaultSectionIds.calendarNews, slug: "news", title: "أخبار التقويم والمواعيد", description: "أخبار التاريخ الهجري والميلادي والمواعيد بعد المراجعة.", parentId: defaultSectionIds.calendar, contentKind: "news", navOrder: 11, enabled: true, publicVisible: true, systemKey: "calendar-news", destinationPath: null },
    { id: defaultSectionIds.calendarGuides, slug: "guides", title: "أدلة تحويل التاريخ", description: "كيف تحوّل التاريخ الهجري وتحسب المواعيد خطوة بخطوة.", parentId: defaultSectionIds.calendar, contentKind: "guide", navOrder: 12, enabled: true, publicVisible: true, systemKey: "calendar-guides", destinationPath: null },
    { id: defaultSectionIds.calendarTools, slug: "tools", title: "أدوات الحساب والتقويم", description: "تحويل التاريخ الهجري، حاسبة العمر، النسبة المئوية، الخصم، وفرق الأيام.", parentId: defaultSectionIds.calendar, contentKind: "tool", navOrder: 13, enabled: true, publicVisible: true, systemKey: "calendar-tools", destinationPath: null },
    { id: defaultSectionIds.calendarSolutions, slug: "solutions", title: "حلول مسائل التاريخ والحساب", description: "حلول لتحويل التاريخ وحساب النسبة والعمر والخصم.", parentId: defaultSectionIds.calendar, contentKind: "solution", navOrder: 14, enabled: true, publicVisible: true, systemKey: "calendar-solutions", destinationPath: null },
    { id: defaultSectionIds.calendarArticles, slug: "articles", title: "مقالات التقويم والتاريخ الهجري", description: "مقالات تشرح التقويم الهجري والتاريخ والحساب اليومي.", parentId: defaultSectionIds.calendar, contentKind: "article", navOrder: 15, enabled: true, publicVisible: true, systemKey: "calendar-articles", destinationPath: null },
    { id: defaultSectionIds.community, slug: "community", title: "أسئلة التاريخ والأدوات", description: "أسئلة عن تحويل التاريخ والحساب بعد المراجعة.", parentId: null, contentKind: null, navOrder: 80, enabled: false, publicVisible: true, systemKey: "community", destinationPath: "/community" },
  ];
}
