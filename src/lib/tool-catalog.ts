...
export const builtInToolCatalog: ToolCatalogEntry[] = [
  {
    ...
    description: "حوّل بين التاريخ الهجري والميلادي، مع التنبيه أن النتيجة حسابية وقد تختلف عن أم القرى.",
  ...
  },
  {
    ...
    description: "احسب عدد الأيام بين تاريخ البداية وتاريخ النهاية بالميلادي.",
  ...
  },
  {
    ...
    description: "احسب العمر بالسنوات والأشهر والأيام بين تاريخ الميلاد وتاريخ تختاره.",
    category: "التاريخ والحساب",
    mode: "client",
  ...
  },
  {
    ...
    description: "اعرف التاريخ بعد عدد من الأيام أو قبله بالإضافة أو الطرح.",
    category: "التاريخ والحساب",
    mode: "client",
  ...
  },
  {
    ...
    description: "اعرف إن كان التاريخ الميلادي يوافق الأحد أو الاثنين أو أي يوم آخر.",
    category: "التاريخ والحساب",
    mode: "client",
  ...
  },
  {
    ...
    description: "احسب قيمة النسبة المئوية أو النسبة بين رقمين أو نسبة التغير.",
  ...
  },
  {
    ...
    description: "أدخل السعر ونسبة الخصم لمعرفة التوفير والسعر بعد التخفيض.",
    category: "الحساب اليومي",
    mode: "client",
  ...
  },
  {
    ...
    description: "اعرف المتبقي حتى تاريخ ووقت تختارهما بالأيام والساعات والدقائق.",
    category: "التاريخ والحساب",
    mode: "client",
  ...
  },
  {
    ...
    description: "احسب مؤشر كتلة الجسم من الوزن والطول وفق تصنيف منظمة الصحة العالمية.",
    category: "الحساب اليومي",
    mode: "client",
